# Mailchimp teaser: Global Warming Map: How Much Warmer Is Each Part of the World Than 1880-1900?

Post URL: https://www.data4thepeople.com/p/climate-globe

```
Subject:  77% of land is now over 1.5°C warmer
Preview:  Spin the globe: every August since 1880, and where warming has passed 1.5°C.
```

## 1. Hero

`images/climate-globe-hero-email.jpg` (same image as the post hero, JPG under 300KB), linked to the post.
...
How much warmer is your part of the world than 1880-1900?
...
**[Spin the globe](https://www.data4thepeople.com/p/climate-globe)**
